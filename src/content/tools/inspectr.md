---
name: Inspectr
description: Observe, mock and test APIs using OpenAPI. Inspectr is a real-time HTTP inspection and debugging tool for APIs and webhooks, built around OpenAPI documents. It helps developers observe live traffic, mock backends from OpenAPI specs, monitor MCP server activity, and debug integrations during development and testing.
